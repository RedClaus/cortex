...
// Supported engines: ollama, openai, anthropic, groq, vllm
//
// vLLM Configuration:
//   - engine: "vllm"
//   - model: model name loaded in vLLM server (e.g., "mistralai/Mistral-7B-Instruct-v0.2")
//   - url: vLLM server endpoint (default: "http://localhost:8000")
//   - api_key: optional, for secured deployments
//
// vLLM provides 5-10x faster inference via continuous batching and PagedAttention.
